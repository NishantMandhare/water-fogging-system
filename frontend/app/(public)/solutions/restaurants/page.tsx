        ...
        <div>
            <section className="relative bg-gray-900 text-white overflow-hidden">
                <div className="absolute inset-0">
                    <Image
                        src="/images/solution-restaurants.jpg"
                        alt="Restaurant mist cooling"
                        fill
                ...
                <div className="relative max-w-4xl mx-auto px-6 pt-40 pb-24 text-center">
                    <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight">
                        Cooling for Restaurants
                    </h1>
                    <p className="text-lg text-white/80 max-w-2xl mx-auto mb-8">
                        Keep outdoor seating comfortable all season, so guests stay
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-gray-50 rounded-xl p-8 text-center">
                            ...
                            <p className="text-gray-600">
                                Extend outdoor dining through hot months instead of losing
                                covers to the heat.
                            </p>
                        </div>
                        <div className="bg-gray-50 rounded-xl p-8 text-center">
                            ...
                            <p className="text-gray-600">
                                No dripping or wet tables — just a fine cooling fog guests
                                barely notice.
                            </p>
                        </div>
                        <div className="bg-gray-50 rounded-xl p-8 text-center">
                            ...
                            <p className="text-gray-600">
                                Discreet piping and nozzles designed to fit your restaurant's
                                look.
                            </p>
                        </div>
                    </div>
